  ...
  shinyServer(function(input, output) {
    ...
    consumerKey="5jEvzrGxYMte5iuuer9rZKisF"
    consumerSecret="CsoenaKZpdzFq8hsr3NnCTNZmFwAqGZFiB3AHNossNfV2oxgYS"
    accessURL="https://api.twitter.com/oauth/access_token"
    authURL="http://api.twitter.com/oauth/authorize"
    reqURL="https://api.twitter.com/oauth/request_token"
    access_token <- "3338923278-KJQlF1jLeE9FEoDGFjtJP8HlHJOdgbMB5CcXH8D"
    access_secret <- "yq3FnDcvRz2gfQLPWi0Ex5d2ws1kcGfI6CLE7O9tG6i3h"
